  ...
  if (!product) {
    ...
    return new ImageResponse(
      ...
      >
        ...
        <div>PUROS MATES</div>
        <div style={{ fontSize: 30, fontWeight: 600, marginTop: 10, color: '#F5F5DC' }}>
    ...
    >
        ...
        >
          {logoSrc && (
            <img
              ...
              height="50"
              alt="Logo Puros Mates"
              style={{ borderRadius: '50%', backgroundColor: 'white', padding: '5px' }}
            />
          )}
          <div
            style={{
      ...
      >
        {productImage ? (
          ...
          <div style={{ fontSize: 40, color: '#ccc', fontFamily: '"Inter"', fontWeight: 600 }}>
            Sin Imagen
          </div>
        )}
      </div>
